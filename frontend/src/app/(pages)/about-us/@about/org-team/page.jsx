  ...
  return (
    <div className='dark:bg-darkbg pt-5'>
        <ul className='grid text-xl grid-cols-2 border-2 border-bluePrime md:flex bg-bluePrime rounded-3xl justify-center w-[80%] m-auto'>
            ...
            <Link href={'/about-us/media-team'} className='w-[100%] flex justify-center items-center text-white py-3 duration-150 hover:bg-white hover:text-bluePrime px-4 font-bold'>
                فريق الإعلامي
            </Link>
            <Link href={'/about-us/org-team'} className='w-[100%] flex justify-center items-center md:rounded-l-3xl  text-bluePrime bg-white py-3 px-4 font-bold'>
                فريق التنظيم
            </Link>
        </ul>
