...
const MoreMain = async() => {
        let req = await fetch('http://localhost:8000/api/posts/tag/1')
  ...
  return (
    <div className='pt-6 dark:bg-darkbg pb-6 border-b-2  border-greenPrime dark:border-darkbg'>
        ...
        <div className='grid md:grid-cols-3 justify-center items-center gap-10 md:gap-0 '>
             ...
             {data.map((lesson) => {
                return (
                    ...
                    <div className='dark:text-white flex flex-col justify-center items-center'>
                        ...
                        <h4 className='font-bold text-center mt-3 w-[250px]'>
                            {lesson.review}
                        </h4>
                    </div>
                ...
                allArticles >= 4 && (
                    <div className='flex justify-center mt-7'>
                         <Link href={'/blog/programming/front-end/all'}
                                className='w-fit bg-white rounded-3xl border-2 border-greenPrime
