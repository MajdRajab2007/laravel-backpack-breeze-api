...
const FofMonth = async() => {

    let req = await fetch("http://localhost:8000/api/fom");
    let res = await req.json();
    console.log(res.name)

    return (
      <div className='dark:bg-darkbg flex justify-center items-center py-8 md:py-12 md:pl-60'>
          ...
          <Image height={100} src={`http://localhost:8000/storage/${res.image}`} alt='...' width={500}/>
         </div>
