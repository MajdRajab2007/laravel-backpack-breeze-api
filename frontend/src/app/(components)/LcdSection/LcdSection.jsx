...
const LcdSection = () => {
  return (
    <div className='dark:bg-darkbg grid md:grid-cols-2 justify-center items-center py-12 px-6'>
        ...
        <div className={`w-[300px] md:w-[600px] h-[250px] md:h-[400px] block col-span-2 md:col-span-1  ${style.background}`} style={{borderRadius:"32px"}}>

        </div>

        <div className=' w-[100%] flex h-[60%] m-auto md:hidden pt-5 flex-col justify-center items-start gap-y-2' style={{direction:'ltr'}}>
            <h1 className='font-extrabold text-4xl text-bluePrime'>Learn</h1>
            <h1 className='font-extrabold text-4xl text-bluePrime' style={{marginLeft:"45px"}}>Create</h1>
            <h1 className='font-extrabold text-4xl text-bluePrime' style={{marginLeft:"90px"}}>Develop</h1>
